...
export default function SignInSignUpComp({ children, title1, title2, titleAdminContact1, titleAdminContact2, btnName,onClick }) {
    return (
        <div>
                ...
                <div className='w-[48%] ml-24'>
                    ...
                    <div className='w-[600px] flex flex-col gap-16 '>
                        ...
                        <form action="">
                            ...
                            {children}
                            <button className="mb-10 w-full h-[70px] bg-blue-500 hover:bg-blue-700 text-white font-adamina py-2 px-4 rounded focus:outline-none focus:shadow-outline" onClick={onClick}>
                                {btnName}
                            </button>
